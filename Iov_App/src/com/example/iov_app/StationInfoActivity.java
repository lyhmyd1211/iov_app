...
public class StationInfoActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.tv_title_button:
			...
			break;
		case R.id.order:
			Intent orderintent = new Intent(StationInfoActivity.this,order.class);
			orderintent.putExtra("station_name", s.getName());
			orderintent.putExtra("station_brand", s.getBrand());
			orderintent.putExtra("Area", s.getArea());
			orderintent.putExtra("Addr", s.getAddr());
			orderintent.putExtra("station", s);
			orderintent.putExtra("username", getIntent().getStringExtra("username"));
